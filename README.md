...
**Budgetify** is a classic example of a budget app. I create a fully functional app that will show the list of expenses and empower user to create payment and track there expenses.
...
- [Budgetify Live Demo](https://budgetify-x0fg.onrender.com/)
...
```sh
  cd my-folder
  git clone https://github.com/Al-Amin-Khan-Shakil/budgetify.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/budgetify/issues).
